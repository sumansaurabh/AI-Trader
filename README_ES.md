...
[*Haz Clic Aquí: Trading en Vivo de IA*](https://ai4trade.ai)

</div>

---
## Amigos de AI-Trader: Otros Proyectos Interesantes
- [TradeTrap](https://github.com/Yanlewen/TradeTrap): Un conjunto de herramientas centrado en seguridad para evaluar y reforzar agentes de trading basados en LLM, con módulos de ataque de inyección de prompts y secuestro de MCP para pruebas de resiliencia.

- [RockAlpha](https://rockalpha.rockflow.ai/): La arena de inversión lanzada por RockFlow. Las entradas de LLM incluyen reglas de trading, datos de mercado, estado de cuenta y poder adquisitivo, así como noticias; la salida es la decisión de ejecución de orden.

- [TwinMarket](https://github.com/FreedomIntelligence/TwinMarket): Un marco multi-agente que aprovecha los LLM para simular el comportamiento de inversores y fenómenos socioeconómicos emergentes en el mercado de acciones A-share.
---
## 🎉 Actualización Semanal

### 📈 Expansión del Mercado
- ✅ **Soporte del Mercado A-Share** - Extendimos nuestras capacidades de trading para incluir los mercados chinos de acciones A-share, ampliando nuestra cobertura global de mercados.
- ✅ **Soporte del Mercado de Criptomonedas** - Añadimos soporte para trading de las principales criptomonedas incluyendo Bitcoin, Ethereum y 8 otros activos digitales líderes.

### ⏰ Capacidades de Trading Mejoradas
- ✅ **Soporte de Trading Horario** - Hemos actualizado de intervalos de trading diarios a horarios, permitiendo una participación en el mercado más precisa y receptiva con control de tiempo granular.
...
- ✅ **Tabla de Clasificación Interactiva** - Lanzamos un sistema de ranking de rendimiento dinámico con actualizaciones en vivo, permitiendo a los usuarios rastrear y comparar el rendimiento de los agentes en tiempo real.

- ⏰ **Aviso Importante** - Para mantener un repositorio bien gestionado, ya no subimos datos de tiempo de ejecución al repositorio, ya que lo haría muy voluminoso. Si necesitas ver datos de tiempo de ejecución, los subiremos a Hugging Face mensualmente. Puedes ver datos de tiempo de ejecución en tiempo real aquí: https://ai4trade.ai.
---
...
Solo necesitas enviar un PR que incluya al menos: `./agent/{tu_estrategia}.py` (¡puedes heredar de Basemodel para crear tu estrategia!), `./configs/{tuconfig}` e instrucciones sobre cómo ejecutar tu estrategia. ¡Siempre que podamos ejecutarlo, lo ejecutaremos en nuestra plataforma durante más de una semana y actualizaremos continuamente tus resultados!

---

<div align="center">

[🚀 Inicio Rápido](#-inicio-rápido) • [📈 Análisis de Rendimiento](#-análisis-de-rendimiento) • [🛠️ Guía de Configuración](#-guía-de-configuración) • [English](README.md) • [中文](README_ZH.md)
...
- 🛠️ **Arquitectura Pura Impulsada por Herramientas**: Construido sobre la cadena de herramientas MCP, permitiendo a la IA completar todas las operaciones de trading mediante llamadas de herramientas estandarizadas
...
### 🎮 Entorno de Trading
Cada modelo de IA comienza con $10,000, 100,000¥ o 50,000 USDT para operar acciones NASDAQ 100, acciones SSE 50 o las principales criptomonedas en un entorno controlado con datos de mercado reales y capacidades de reproducción histórica.
...
- ⏰ **Horario de Trading**: Toda la semana para criptomonedas, horarios de mercado en días hábiles para acciones con soporte de simulación histórica
- 📊 **Integración de Datos**: API de Alpha Vantage combinada con inteligencia de mercado Jina AI
- 🔄 **Gestión del Tiempo**: Reproducción de período histórico con filtrado automatizado de información futura
...
🎯 **Objetivo**: ¡Determinar qué modelo de IA logra retornos de inversión superiores mediante operación autónoma pura!
...
- ✅ **Ejecución Solo con Herramientas**: Todas las operaciones ejecutadas exclusivamente mediante llamadas de herramientas estandarizadas
- ✅ **Aprendizaje Auto-Adaptativo**: Refinamiento independiente de estrategia basado en la retroalimentación del rendimiento del mercado

---

## ⏰ Arquitectura de Reproducción Histórica

Una innovación central de AI-Trader Bench es su entorno de trading **completamente reproducible**, asegurando rigor científico y reproducibilidad en la evaluación del rendimiento de agentes de IA sobre datos históricos de mercado.
...
### 🛡️ Controles Anti-Look-Ahead de Datos
La IA solo puede acceder a datos de mercado desde el tiempo actual y antes. No se permite información futura.

- 📊 **Límites de Datos de Precio**: Acceso a datos de mercado limitado a la marca de tiempo de simulación y registros históricos
...
- 📊 **Estudios de Eficiencia de Mercado**: Evaluar el rendimiento de IA a través de diversas condiciones de mercado y regímenes de volatilidad
...
- 📈 **Evaluación de Gestión de Riesgo**: Validar la efectividad de estrategias de mitigación de riesgo impulsadas por IA
...
│   │   │   ├── crypto_merged.jsonl         # 🔄 Formato de datos unificado de criptomonedas
│   │   │   ├── get_daily_price_crypto.py   # 📥 Script de obtención de datos de criptomonedas
│   │   │   └── merge_crypto_jsonl.py       # 🔄 Conversión de formato de datos de criptomonedas
...
- **Concurrencia Multi-Modelo**: Ejecuta múltiples modelos de IA simultáneamente para trading
- **Carga Dinámica de Agentes**: Carga automáticamente el tipo de agente correspondiente según la configuración
- **Gestión de Configuración**: Soporte para archivos de configuración JSON y variables de entorno
- **Gestión de Fechas**: Configuraciones flexibles de calendario de trading y rango de fechas
...
|-----------|-------------|----------|----------|
| **BaseAgent** | `agent.base_agent` | EE.UU./A-shares genérico | Cambio de mercado flexible, pool de acciones configurable |
| **BaseAgentAStock** | `agent.base_agent_astock` | Específico de A-share | Reglas A-share incorporadas, pool predeterminado SSE 50, prompts en chino |
| **BaseAgentCrypto** | `agent.base_agent_crypto` | Específico de criptomonedas | Pool de criptomonedas BITWISE10, denominado en USDT |
...
| **Herramienta Matemática** | Cálculos financieros y análisis | Genérico | Operaciones matemáticas básicas |

**Características de Herramientas**:
- 🔍 **Auto-Reconocimiento**: Selecciona automáticamente la fuente de datos según el formato del símbolo (códigos de acciones o símbolos de criptomonedas)
- 📏 **Adaptación de Reglas**: Auto-aplica reglas de trading de mercado correspondientes (T+0/T+1, tamaños de lote, etc.)
- 🌐 **Interfaz Unificada**: La misma interfaz API soporta trading multi-mercado a través de acciones y criptomonedas

#### 📊 Sistema de Datos
- **📈 Datos de Precio**:
  - 🇺🇸 Datos OHLCV completos para acciones componentes del NASDAQ 100 (Alpha Vantage)
  - 🇨🇳 Datos del mercado A-share (Índice SSE 50) vía API Tushare
  - ₿ Datos del mercado de criptomonedas (BITWISE10) vía Alpha Vantage
  - 📁 Formato JSONL unificado para lectura eficiente
- **📝 Registros de Trading**:
  - Historia de trading detallada para cada modelo de IA
  - Almacenados separadamente por mercado: `agent_data/` (EE.UU.), `agent_data_astock/` (A-shares), `agent_data_crypto/` (Cripto)
- **📊 Métricas de Rendimiento**:
  - Ratio de Sharpe, drawdown máximo, retornos anualizados, etc.
...
- **🔄 Sincronización de Datos**:
  ...
  - Scripts de obtención de datos independientes con soporte de actualización incremental
...
- **Claves API**:
  ...
  - Tushare (para datos del mercado A-share, opcional)
...
cp .env.example .env
# Edita el archivo .env y completa tus claves API
```
...
ALPHAADVANTAGE_API_KEY=your_alpha_vantage_key  # Para datos NASDAQ 100
JINA_API_KEY=your_jina_api_key
TUSHARE_TOKEN=your_tushare_token               # Para datos A-share
...
#### 🇨🇳 Datos del Mercado A-Share (SSE 50)

```bash
# 📈 Obtener datos del mercado chino A-share (Índice SSE 50)
cd data/A_stock
...
```json
{
  ...
  "market": "cn",                   // Tipo de mercado: "cn" para A-shares (opcional, se ignorará, siempre usa cn)
  "date_range": {
...
| Ítem de Regla | Acciones Estadounidenses | A-Shares (China) | Criptomonedas |
|-----------|-----------|------------------|------------------|
| **💰 Capital Inicial** | $10,000 | ¥100,000 | 50,000 USDT |
| **📈 Objetivos de Trading** | NASDAQ 100 | SSE 50 | Principales Criptomonedas BITWISE10 |
| **🌍 Mercado** | Mercado de Valores de EE.UU. | Mercado A-Share de China | Mercado Global de Cripto |
| **⏰ Horario de Trading** | Días hábiles | Días hábiles | Toda la Semana |
...
| `market` | Tipo de mercado | "us" (acciones estadounidenses)<br>"cn" (A-shares)<br>"crypto" (Criptomonedas)<br>Nota: Auto-establecido en "cn" al usar BaseAgentAStock, "crypto" al usar BaseAgentCrypto | "us" |
...
#### 📋 Detalles del Tipo de Agente

| Tipo de Agente | Mercados Aplicables | Características |
|-----------|-------------------|----------|
| **BaseAgent** | EE.UU. / A-shares | • Agente de trading genérico<br>• Cambiar mercados vía parámetro `market`<br>• Configuración flexible del pool de acciones |
| **BaseAgentAStock** | Específico A-share | • Optimizado para A-shares<br>• Reglas de trading A-share incorporadas (lotes de 100 acciones, T+1)<br>• Pool de acciones SSE 50 predeterminado<br>• Precio en Yuan Chino |
| **BaseAgentCrypto** | Específico Cripto | • BITWISE 10 predeterminado<br>• Precio USDT |
...
- [Tushare](https://tushare.pro/) - API de datos del mercado A-share de China
...
**🛠️ Ejecución pura impulsada por herramientas con cero intervención humana—¡una auténtica arena de trading de IA!** 🚀
